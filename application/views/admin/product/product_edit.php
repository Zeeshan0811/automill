                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select data-placeholder="Select Product Category" name="category" class="form-control form-control-select2" data-fouc="" required>
                                        <option value="" selected>Choose any</option>
                                        <?php foreach ($categories as $item) { ?>
                                            <option value="<?php echo $item->unitId; ?>"><?php echo $item->title; ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Brand:</label>
                                    <select data-placeholder="Select Brand of Product" class="form-control form-control-select2" name="brand" data-fouc="" required>
                                        <option value="" selected>Choose any</option>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="name" placeholder="Please Enter Product Name" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Size:</label>
                                    <input type="text" class="form-control" name="size" placeholder="Product Size" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="sale_price" placeholder="Sell Price" required>
                                </div>
                            </div>
                        </div>
